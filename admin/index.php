...
<div class="tab-content">
    <div class="tab-pane fade show active" id="active-tab">
        <div class="card shadow-sm"><div class="card-body p-0 table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light"><tr><th>Subject</th><th>Title</th><th>Date / Period</th><th>Actions</th></tr></thead>
                <tbody>
    ...
    <div class="tab-pane fade" id="archived-tab">
        <div class="card shadow-sm"><div class="card-body p-0 table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light"><tr><th>Subject</th><th>Title</th><th>Actions</th></tr></thead>
                <tbody>
