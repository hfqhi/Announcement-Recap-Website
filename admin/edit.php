...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    logAction($pdo, $_SESSION['admin_id'], $id, 'updated');
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="mb-3"><label>Title</label><input type="text" name="title" class="form-control" value="<?= e($item['title']) ?>" required></div>
                    <div class="mb-3"><label>Content</label><textarea name="content" class="form-control" rows="5" required><?= e($item['content']) ?></textarea></div>
                    <div class="row">
