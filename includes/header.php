...
<head>
    ...
    <title><?= isset($pageTitle) ? $pageTitle . ' - CPE3B' : 'CPE3B Announcements' ?></title>
        ...
        <div class="container">
            ...
            <?php if ($isAdmin): ?>
                <a class="navbar-brand fw-bold d-flex align-items-center" href="/admin/index.php">
                    <i class="bi bi-shield-lock fs-4 me-2 text-warning"></i>
            ...
            <?php else: ?>
                <!-- Updated Fallback Navbar Text to 3rd Year, 1st Semester -->
                <a class="navbar-brand fw-bold mx-auto" href="/">CPE-3B 1st Semester SY 2026-2027</a>
            <?php endif; ?>
